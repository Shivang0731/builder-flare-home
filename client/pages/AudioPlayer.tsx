      ...
      <div className="flex-1 flex flex-col">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Listen to AI-generated audio summary of your document
          </p>
        </div>
            ...
            <Card className="mb-8">
              <CardHeader>
                <CardTitle className="text-center">
                  Document Audio Summary
                </CardTitle>
                <p className="text-center text-sm text-gray-600">
                  Photosynthesis - Biology Chapter 5
                </p>
              </CardHeader>
                ...
                <CardContent>
                  <div className="bg-gray-50 rounded-lg p-4 max-h-64 overflow-y-auto">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Photosynthesis is a vital biological process that occurs
                      in plants, algae, and some bacteria. During this process,
                      organisms convert light energy, usually from the sun, into
                      chemical energy stored in glucose molecules. The process
                      involves two main stages: the light-dependent reactions
                      and the light-independent reactions, also known as the
                      Calvin cycle.
                      <br />
                      <br />
                      The light-dependent reactions occur in the thylakoid
                      membranes of chloroplasts, where chlorophyll and other
                      pigments capture light energy. This energy is used to
                      split water molecules, releasing oxygen as a byproduct and
