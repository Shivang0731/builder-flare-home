...
import { Brain, Plus, Edit3, Trash2, RotateCcw, CheckCircle, XCircle, ArrowLeft } from "lucide-react";
...
export default function Flashcards() {
  const [flashcards, setFlashcards] = useState<Flashcard[]>([
    { id: 1, question: "What is photosynthesis?", answer: "The process by which plants use sunlight to produce glucose from carbon dioxide and water.", difficulty: 'medium', category: 'Biology' },
    { id: 2, question: "What is the mitochondria?", answer: "The powerhouse of the cell, responsible for producing ATP energy.", difficulty: 'easy', category: 'Biology' },
    { id: 3, question: "What is Newton's First Law?", answer: "An object at rest stays at rest, and an object in motion stays in motion, unless acted upon by an external force.", difficulty: 'hard', category: 'Physics' },
    { id: 4, question: "What is DNA?", answer: "Deoxyribonucleic acid, the hereditary material in humans and almost all other organisms.", difficulty: 'medium', category: 'Biology' }
  ]);
  ...
  const [newCard, setNewCard] = useState({ question: '', answer: '', difficulty: 'medium' as const, category: '' });
  ...
  const addFlashcard = () => {
    ...
    setNewCard({ question: '', answer: '', difficulty: 'medium', category: '' });
        ...
        {studyMode ? (
          ...
          <div className="max-w-2xl mx-auto">
            <div className="mb-6 text-center">
              ...
              <Progress value={((currentCard + 1) / flashcards.length) * 100} className="mt-4" />
            </div>
                ...
                <div className="flex justify-center mt-6">
                  {!showAnswer ? (
                    ...
                    <div className="flex space-x-4">
                      <Button variant="outline" size="lg" onClick={markIncorrect}>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  Correct: {correctAnswers} / {currentCard + (showAnswer ? 1 : 0)}
                </p>
              </div>
          ...
          <div>
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Your Flashcards</h1>
              <p className="text-gray-600">Manage and study your flashcard collection</p>
            </div>
